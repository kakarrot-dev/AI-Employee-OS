...
export interface MemoryQueueItemView { id: string; sourceType: 'conversation' | 'task'; sourceRef: string; scopeType: MemoryScopeTypeView; scopeId: string; state: 'pending_authorization'; createdAt: string }
