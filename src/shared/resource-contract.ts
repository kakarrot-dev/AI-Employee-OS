export interface ResourceCatalogView {
  skills: Array<{ id: string; createdAt: string; name: string; description: string; version: number; steps: string[]; toolVersionIds: string[]; available: boolean; reason?: string }>
