import { DEFAULT_SUPERVISOR_CONFIG, normalizeSupervisorConfig, SUPERVISOR_ID, validateSupervisorConfig, type SupervisorConfigInput, type SupervisorConfigView } from '../shared/supervisor-contract'
