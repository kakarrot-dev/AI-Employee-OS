...
- 文档能力不提供消息、写入、日历或通讯录操作。2026-09-07 新增可选的[飞书会议场景](feishu-meeting-scenario.md)：独立会议助理与三个 Tool，按用户选项申请会议、组织内联系人搜索和用户身份消息发送权限；缺少会议权限不影响已授权的文档能力。不能把“已连接”当作会议已授权。
