...
VALID_CASES = (
    ...
    ("task-proposal.schema.json", "examples/task-proposal.valid.json"),
    ("task-room-timeline.schema.json", "examples/task-room-timeline.valid.json"),
...
INVALID_CASES = (
    ...
    ("task-proposal.schema.json", "fixtures/task-proposal.invalid-extra-field.json"),
